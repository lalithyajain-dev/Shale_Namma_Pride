...
data class GalleryImage(
    @get:PropertyName("id") @set:PropertyName("id") var id: String = "",
    @get:PropertyName("imageUrl") @set:PropertyName("imageUrl") var imageUrl: String = "",
    @get:PropertyName("descriptionEn") @set:PropertyName("descriptionEn") var descriptionEn: String = "",
    @get:PropertyName("descriptionKn") @set:PropertyName("descriptionKn") var descriptionKn: String = "",
    @get:PropertyName("timestamp") @set:PropertyName("timestamp") var timestamp: Long = System.currentTimeMillis()
)
